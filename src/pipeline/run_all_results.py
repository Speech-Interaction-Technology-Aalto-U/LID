...
EMBEDDING_STEPS = [
    ...
    (
        ...
        PIPELINE_DIR / "1_average_enrolment_embeddings.py",
    ),
    (
        "Create scores from embeddings",
        PIPELINE_DIR / "2_create_scores_from_embeddings.py",
    ),
]
...
PIPELINE_STEPS = [
    ...
    (
        "Calibrate scores",
        PIPELINE_DIR / "3_calibrate_scores.py",
    ),
    (
        "Create local information disclosures",
        PIPELINE_DIR / "4_inner_aggregator.py",
    ),
    (
        "Aggregate experiment results",
        PIPELINE_DIR / "5_outer_aggregator.py",
    ),
    (
        "Plot results",
        PIPELINE_DIR / "6_create_plots_and_summaries.py",
    ),
]
