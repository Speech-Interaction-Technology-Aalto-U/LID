...
![Complementary Cumulative Distribution Function (CCDF) of the localised information disclosure across evaluation trials](results/readme_figures/Figure4.png)
...
* **`results/summary/`**: Full-precision result summaries and rounded CSV copies of Tables 3 and 4 for inspection.
* **`results/paper_figures/`**: Title-free figure PDFs and LaTeX tables that exactly match the paper, including legend-free versions of Figures 4 and 5.
* **`results/readme_figures/`**: PNG copies of the figures displayed in this README.
...
The MeanD values shown in Table 4 are sourced from prior research through a fixed experiment-name lookup; this pipeline does not compute MeanD. Experiments without a matching lookup entry have an empty MeanD value, and the column is omitted when no evaluated experiment has a known value.
...
<table>
  <tr>
    <td><img src="results/readme_figures/Figure2.png" alt="Empirical distribution of the posterior probability assigned to the target identity" width="100%"/></td>
    <td><img src="results/readme_figures/Figure3.png" alt="Distribution of Local Information Disclosure (LID) across evaluation trials" width="100%"/></td>
  </tr>
</table>
